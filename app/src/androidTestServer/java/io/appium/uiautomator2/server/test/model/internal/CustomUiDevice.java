package io.appium.uiautomator2.server.test.model.internal;
...
import static io.appium.uiautomator2.server.test.utils.ReflectionUtils.getField;
...
public class CustomUiDevice {
    ...
    public CustomUiDevice() {
        try {
            ...
            this.mInstrumentation = (Instrumentation) ReflectionUtils.getField(UiDevice.class, FIELD_M_INSTRUMENTATION, Device.getUiDevice());
            this.API_LEVEL_ACTUAL = ReflectionUtils.getField(UiDevice.class, FIELD_API_LEVEL_ACTUAL, Device.getUiDevice());
    ...
    public Object findObject(Object selector) throws ClassNotFoundException, ElementNotFoundException, InvalidSelectorException, UiAutomator2Exception {
        ...
        if (selector instanceof BySelector) {
            node = (AccessibilityNodeInfo) ReflectionUtils.invoke(METHOD_FIND_MATCH, ByMatcher, Device.getUiDevice(), selector, getWindowRoots());
            ...
            UiObject uiObject = Device.getUiDevice().findObject((UiSelector) selector);
            if(uiObject.exists()) {
                return uiObject;
            }
            return null;
        ...
        try {
            ...
            Object[] constructorParams = {Device.getUiDevice(), selector, node};
    ...
    public List<Object> findObjects(Object selector) throws ClassNotFoundException, InvalidSelectorException, UiAutomator2Exception {
        ...
        if (selector instanceof BySelector) {
            ...
            Object nodes = ReflectionUtils.invoke(METHOD_FIND_MATCHS, ByMatcher, Device.getUiDevice(), selector, getWindowRoots());
